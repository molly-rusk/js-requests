...
const repeatMyParam = () => {
    ...
    axios.get('http://localhost:3000/repeat/molly')
    .then(res => {
...
/*
    ...
    returns a string "you sent an empty query"

    2: Send more than 1 query on the URL -- what happened? 

    returns an object with a message saying "you sent more than 1 query" and displays the queries
*/
...
const submitButton = document.getElementById('food-submit')
